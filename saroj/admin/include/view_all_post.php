...
<table class="table table-bordered table-hover">
        ...
        <span class="text-right"><h1>All POST</h1></span>
...
// $query = "SELECT post.post_id, post.category_id, post.post_title, post.post_author, post.post_date, post.post_image, post.post_content, post.post_tags";
// $query .= "post.post_comment_count, post.post_status, categories.cat_id, categories.cat_title";
// $query .= "FROM post";
// $query .= "LEFT JOIN categories ON post.category_id = categories.cat_id";
