...
echo "Post Updated: " . " " . " <a href = 'post.php?source=view_post&p_id={$edit_post_id}'>View Post</a> or <a href='./post.php'>Edit More Posts</a>";


}
  
?>
<span class="text-right"><h3>EDIT POST</h3></span>
